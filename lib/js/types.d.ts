export as namespace emojioneCustom;
...
export function toImage(str: string, dataset: string, isUnified: boolean): string;
export function shortnameToImage(str: string, dataset: string): string;
